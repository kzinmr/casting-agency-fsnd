...
AUTH0_DOMAIN = "fsnd-kzinmr.auth0.com"
ALGORITHMS = ["RS256"]
...
def verify_decode_jwt(token):
    ...
    # Check if the data is an Auth0 token with key id (kid)
    rsa_key = {}
    ...
    # Get the public key from Auth0 /.well-known/jwks.json
    ...
    # Validate the claims through the exception handling
    if rsa_key:
        try:
            payload = jwt.decode(
                token,
...
"""
    ...
    it should use the check_permissions method to validate claims
